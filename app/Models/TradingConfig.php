...
class TradingConfig extends Model
{
    ...
    public static function pluckDefaults(): void
    {
        $defaults = [
            ...
            ['product', 'product.weights.decline', 'float', 'Decline weight', 'Composite score weight', 0.20],
            ['product', 'product.weights.reversal', 'float', 'Reversal weight', 'Composite score weight', 0.25],
            ['product', 'product.weights.volume', 'float', 'Volume weight', 'Composite score weight', 0.20],
