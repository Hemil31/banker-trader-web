...
function _(e) {
    ...
    t[0] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((i = (0, g.jsx)(r, { title: `Integration settings` })), (t[0] = i))
        : (i = t[0]);
    let a;
        ...
        ? ((a = (0, g.jsxs)(`div`, {
              children: [
                  ...
                  (0, g.jsx)(`p`, {
                      ...
                      children: `App-level API keys shared across every user. These never appear in the mobile app's per-account config screen.`,
                  }),
              ],
          })),
          (t[1] = a))
                      ...
                      (0, g.jsxs)(`div`, {
                          ...
                          children: [
                              ...
                              n.length === 0
                                  ? (0, g.jsx)(f, {
                                        children: (0, g.jsx)(u, {
                                            className: `text-muted-foreground pt-6 text-sm`,
                                            children: `No admin-only settings registered yet.`,
                                        }),
                                    })
                                  : (0, g.jsx)(`div`, {
...
function v(e) {
    return (0, g.jsx)(y, { setting: e }, e.key);
}
function y(e) {
    let t = (0, h.c)(17),
        { setting: r } = e,
    ...
    t[2] === y
        ? (b = t[3])
        : ((b = (0, g.jsx)(c, { children: y })), (t[2] = y), (t[3] = b));
    let x;
    t[4] === r.description
        ? (x = t[5])
        : ((x = r.description && (0, g.jsx)(d, { children: r.description })),
          (t[4] = r.description),
          (t[5] = x));
    let S;
    t[6] !== b || t[7] !== x
        ? ((S = (0, g.jsxs)(l, { children: [b, x] })),
          (t[6] = b),
          (t[7] = x),
          (t[8] = S))
        : (S = t[8]);
